...
export default function Events() {
  ...
  return (
    <section className="w-full max-w-full px-0 md:px-16 py-0 md:py-12 overflow-x-clip overflow-y-visible">
      <motion.div
        className="w-full max-w-full bg-[#E5DACE] md:rounded-[40px] md:border-[#4A3F35]/50 md:border-[1px] p-6 md:p-14 flex flex-col md:flex-row md:items-stretch gap-y-8 md:gap-x-20 relative overflow-hidden"
        initial={{ opacity: 0, x: isMobile ? -24 : -64 }}
